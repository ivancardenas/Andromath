...
import static co.edu.eafit.andromath.linearsystems.gaussianelimination.util.MatrixUtils.partialPivoting;
...
public class PivotingGaussLUFactorizationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pivoting_gauss_lufactorization);
        ...
        pivotingGaussLUFactorization(augmentedMatrix);
    }

    private void pivotingGaussLUFactorization(BigDecimal[][] augmentedMatrix) {
        ...
        for (int k = 0; k < n - 1; k++) {
            ...
            augmentedMatrix = partialPivoting(augmentedMatrix, k);
