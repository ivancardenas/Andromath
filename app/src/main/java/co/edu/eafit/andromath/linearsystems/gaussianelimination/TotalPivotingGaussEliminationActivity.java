...
public class TotalPivotingGaussEliminationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addMatrixSolution(totalPivotingGaussElimination(matrixValues));
    }

    private BigDecimal[] totalPivotingGaussElimination(BigDecimal[][] matrixValues) {
        ...
        MatrixUtils.MatrixMarks matrixMarks;

        for (int k = 0; k < n - 1; k++) {

            matrixMarks = MatrixUtils.totalPivoting(matrixValues, k, marks);
            matrixValues = matrixMarks.matrixValues;
            marks = matrixMarks.matrixMarks;
        ...
        BigDecimal solution[] = MatrixUtils.regressiveSubstitution(matrixValues);

        return MatrixUtils.markAwareX(solution, marks);
    }
